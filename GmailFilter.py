...
if __name__ == '__main__':
    ...
    include_all_compiled, exclude_any_compiled, order_id_patterns, domain_patterns = load_from_json("keywords.json")
    if not include_all_compiled and not exclude_any_compiled:
        print("No keywords loaded")
        exit(1)

    filter_messages_by_keywords(service, include_all_compiled, exclude_any_compiled, order_id_patterns, domain_patterns)
